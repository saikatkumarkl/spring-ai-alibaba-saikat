...
import com.alibaba.cloud.ai.studio.admin.builder.generator.model.workflow.nodedata.HttpNodeData;
	...
	private enum HttpNodeDialectConverter {
		...
		DIFY(new DialectConverter<>() {
			...
			public HttpNodeData parse(Map<String, Object> data) throws JsonProcessingException {
				...
				List<com.alibaba.cloud.ai.studio.admin.builder.generator.model.Variable> outputs = List.of();
